...
//       >
//         <div 
//           className={`relative max-w-4xl mx-auto rounded-xl shadow-2xl backdrop-blur-md transform transition-all duration-500 ease-out ${
//             isMenuOpen ? 'translate-y-0 scale-100' : '-translate-y-full scale-95'
//           }`}
//           style={{
//             background: 'linear-gradient(135deg, #c4bec7 0%, #d4cdd7 50%, #c4bec7 100%)',
...
//             className="absolute top-3 right-3 p-2 rounded-full bg-black bg-opacity-10 hover:bg-opacity-20 transition-all duration-300 transform hover:scale-110 z-50"
//           >
//             <div className="w-4 h-4 relative">
//               <div className="absolute inset-0 w-4 h-0.5 bg-black rounded-full transform rotate-45 top-1.5"></div>
//               <div className="absolute inset-0 w-4 h-0.5 bg-black rounded-full transform -rotate-45 top-1.5"></div>
//             </div>
//           </button>
...
//                   <div className="w-1 h-5 bg-black rounded-full mr-3"></div>
//                   Navigation
//                 </h3>
...
//                       key={link.name}
//                       href={link.href}
//                       className="group relative overflow-hidden bg-white bg-opacity-30 hover:bg-opacity-50 rounded-lg p-3 transition-all duration-300 transform hover:scale-105 hover:shadow-md"
//                       style={{ 
...
//                       <span className="relative z-10 text-black font-medium group-hover:text-gray-900 transition-colors duration-300 text-sm">
//                         {link.name}
//                       </span>
//                     </a>
//                   ))}
...
//                         className={`group flex items-center space-x-3 p-2 bg-white bg-opacity-30 hover:bg-opacity-50 rounded-lg transition-all duration-300 transform hover:scale-105 ${social.color}`}
//                         style={{ 
//                           animationDelay: `${(index + navLinks.length) * 0.05}s`,
//                           animation: isMenuOpen ? 'slideInFromTop 0.4s ease-out forwards' : 'none'
//                         }}
//                       >
//                         <IconComponent className="w-4 h-4 text-black group-hover:scale-110 transition-transform duration-300" />
//                         <span className="text-black font-medium text-sm">{social.name}</span>
//                       </a>
//                     );
//                   })}
//                 </div>
...
//                       <span className="text-black font-medium">info@ozmedia.com</span>
//                     </div>
//                     <div className="flex items-center text-sm">
//                       <Phone className="w-4 h-4 mr-2 text-black" />
//                       <span className="text-black font-medium">+1 (234) 567-8900</span>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//               <button 
//                 className="w-full bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 font-medium text-sm"
//                 onClick={() => setIsMenuOpen(false)}
//               >
//                 Get in Touch
//               </button>
