...
import { ChevronDown, Mail, Database, Share2, Shield, Eye, Lock, Link, Bell,  } from 'lucide-react';
...
const PrivacyPolicy = () => {
 ...
 const sections = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8fafc] to-white lg:px-10 px-2 md:px-6 py-4 space-y-6">
      {/* Animated Header */}
      <div className={`bg-white transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-[#0f294d] mb-4 animate-fadeIn">
              Oz Media Planet
            </h1>
            <div className="w-24 h-1.5 bg-[#005f73] mx-auto mb-6 rounded-full animate-grow origin-left scale-x-0 animate-fill-forwards" style={{ animationDelay: '300ms' }}></div>
            <p className="text-lg text-gray-600 animate-fadeIn" style={{ animationDelay: '500ms' }}>Innovative IT Solutions for the Digital Age</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-12">
        {/* Introduction */}
        <div className={`bg-white rounded-xl p-8 mb-12 shadow-lg transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[#0f294d] mb-4">
              Privacy Policy
            </h2>
            <div className="w-16 h-1 bg-[#005f73] mx-auto mb-6 rounded-full animate-grow origin-left scale-x-0 animate-fill-forwards" style={{ animationDelay: '400ms' }}></div>
            <p className="text-gray-500 text-sm">
              Effective Date: 01-01-2025 | Last Updated: 01-01-2025
            </p>
          </div>
          
          <div className="bg-[#f0f9ff] rounded-xl p-6 border-l-4 border-[#005f73] animate-fadeIn" style={{ animationDelay: '600ms' }}>
            <p className="text-gray-700 text-lg leading-relaxed">
              At Oz Media Planet, your privacy is our priority. This Privacy Policy outlines how we collect, use, and safeguard your information when you interact with our website and services.
            </p>
          </div>
        </div>
          ...
          {sections.map((section, index) => (
            <div
              ...
              style={{
                ...
                borderTop: `4px solid ${section.id % 2 === 0 ? '#005f73' : '#0f294d'}`,
                ...
                <div className="flex items-center justify-between">
                  ...
                  <ChevronDown 
                    className={`w-5 h-5 text-gray-500 transition-all duration-300 ${
                      expandedSection === section.id ? 'transform rotate-180 text-[#005f73]' : ''
                    }`}
                  />
                </div>
              </button>
  ...
  className={`overflow-hidden transition-all duration-500 ease-in-out ${
    expandedSection === section.id ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'
  }`}
>
                    ...
                    {section.content.map((item, itemIndex) => (
                      <li 
                        ...
                        style={{
                          ...
                          transitionDelay: expandedSection === section.id ? `${itemIndex * 50 + 200}ms` : '0ms'
                        }}
                      >
                        <span className={`mt-1 ${section.id % 2 === 0 ? 'text-[#005f73]' : 'text-[#0f294d]'}`}>•</span>
        ...
        {/* Contact Section */}
        <div className={`bg-gradient-to-r from-[#005f73] to-[#0f294d] rounded-xl p-8 mt-12 shadow-lg text-white transition-all duration-1000 delay-800 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}>
          <div className="text-center max-w-2xl mx-auto">
            <div className="flex justify-center mb-4">
              <Mail className="w-8 h-8 text-white animate-bounce" style={{ animationDelay: '100ms', animationDuration: '2s', animationIterationCount: 3 }} />
            </div>
            <h3 className="text-2xl font-bold mb-4">
              Privacy Concerns or Questions?
            </h3>
            <p className="mb-6 text-white/90">
              If you have any questions about our privacy practices or need to exercise your rights under the Digital Personal Data Protection Act, 2023, please contact us:
            </p>
            <button
              onClick={copyEmail}
            ...
            <p className="text-white/70 text-sm mt-2 animate-pulse" style={{ animationDuration: '2s' }}>Click to copy email address</p>
          </div>
        </div>

        {/* Policy Update Note */}
        <div className={`mt-8 p-4 bg-[#f0f9ff] rounded-lg border border-[#005f73]/20 transition-all duration-1000 delay-900 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}>
          <p className="text-center text-gray-700">
            <strong>Note:</strong> Oz Media Planet may update this Privacy Policy periodically. All updates will be posted on this page with the updated effective date.
          </p>
        </div>
        ...
        <div className={`text-center mt-12 transition-all duration-1000 delay-1000 ${
          ...
          <div className="border-t border-gray-200 pt-8">
            <p className="text-gray-500">
              © 2025 Oz Media Planet. All rights reserved. | Last updated: January 2025
            </p>
          </div>
        </div>
      </div>
